  ...
  return (
    <Link to="/shop">
      <div className="w-full h-80 mb-20 bg-[#f3f3f3] md:bg-transparent relative font-titleFont">
        ...
        />
        <div className="w-full md:w-1/2 xl:w-1/2 h-80 absolute px-4 md:px-0 top-0 right-0 flex flex-col items-start gap-6 justify-center">
          <h1 className="text-3xl font-semibold text-white">
            Các sản phẩm của năm
          </h1>
          <p className="text-base font-normal text-white max-w-[600px] mr-4">
            Click vào để mua sắm ngay cùng Orebi nào.
          </p>
          <ShopNow />
        </div>
      </div>
